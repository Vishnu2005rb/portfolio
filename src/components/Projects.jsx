...
import { Terminal, Cpu, Database, Send, Award, ArrowUpRight } from "lucide-react";
              ...
              <div className="p-6 text-left flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex justify-between items-start mb-3">
                    <h4 className="text-white font-sans font-bold text-lg leading-tight group-hover:text-cyber-cyan transition-colors">
                      {proj.title}
                    </h4>
                    <a
                      href={proj.gitLink}
                      ...
                      className="text-gray-400 hover:text-white p-1 rounded hover:bg-white/5 transition-colors border border-transparent hover:border-white/10"
                    >
